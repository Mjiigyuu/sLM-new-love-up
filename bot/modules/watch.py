...
def _watch(bot: Bot, update, isTar=False, isZip=False, isLeech=False):
    ...
    try:
        ...
        msg += f"\n\n😎 Example:\n<code>/{BotCommands.WatchCommand} https://youtu.be/un00kN_i 720 |@MIRRORDDRIVE</code>\n\n"
        msg += "This file will be downloaded in 720p quality and it's name will be <b>@MIRRORDDRIVE</b>"
